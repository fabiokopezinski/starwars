...
@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Retorna um planeta", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,schema = @Schema(implementation = PlanetResponse.class))),
...
@Operation(summary = Constants.PLANET_SEARCH_NAME_SUMMARY, description = Constants.PLANET_SEARCH_NAME_DESCRIPTION)
public @interface PlanetGetNameCodeStandard {
